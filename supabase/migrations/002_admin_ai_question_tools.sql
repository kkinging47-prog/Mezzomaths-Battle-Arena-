-- Optional migration for AI-generated questions, 1v1 topic areas, maths symbols and image-based questions/options.

alter table public.question_bank
  add column if not exists topic_area text,
  add column if not exists topic_sublevel text,
  add column if not exists battle_mode text default 'solo',
