...
const beceSets = {
  samples: [
    { topic: 'Number', q: 'Simplify: 3/4 + 1/8', options: ['1/2', '7/8', '5/8', '1'], answer: 'B', explanation: '3/4 is 6/8, and 6/8 + 1/8 = 7/8.' },
    { topic: 'Algebra', q: 'If 2x + 5 = 17, find x.', options: ['4', '5', '6', '7'], answer: 'C', explanation: '2x = 12, so x = 6.' },
    { topic: 'Geometry', q: 'Find the area of a rectangle with length 12 cm and breadth 7 cm.', options: ['19 cm²', '38 cm²', '84 cm²', '96 cm²'], answer: 'C', explanation: 'Area = length × breadth = 12 × 7 = 84 cm².' },
    { topic: 'Statistics', q: 'The marks are 4, 6, 8, 10, 12. What is the mean?', options: ['7', '8', '9', '10'], answer: 'B', explanation: 'Sum = 40. Mean = 40 ÷ 5 = 8.' },
    { topic: 'Percentages', q: 'Find 20% of 250.', options: ['25', '40', '50', '60'], answer: 'C', explanation: '20% of 250 = 20/100 × 250 = 50.' },
    { topic: 'Ratio', q: 'Share GHS 60 in the ratio 2:3. What is the larger share?', options: ['GHS 20', 'GHS 24', 'GHS 30', 'GHS 36'], answer: 'D', explanation: 'Total parts = 5. Larger share = 3/5 × 60 = 36.' },
    { topic: 'Angles', q: 'Two angles on a straight line are x and 65°. Find x.', options: ['25°', '95°', '115°', '125°'], answer: 'C', explanation: 'Angles on a straight line sum to 180°. x = 180 − 65 = 115°.' },
    { topic: 'Speed', q: 'A car travels 180 km in 3 hours. Find its average speed.', options: ['30 km/h', '45 km/h', '60 km/h', '90 km/h'], answer: 'C', explanation: 'Speed = distance ÷ time = 180 ÷ 3 = 60 km/h.' },
    { topic: 'Indices', q: 'Evaluate 2³ × 2².', options: ['16', '24', '32', '64'], answer: 'C', explanation: '2³ × 2² = 2⁵ = 32.' },
    { topic: 'Probability', q: 'A bag contains 3 red balls and 2 blue balls. What is the probability of picking a blue ball?', options: ['2/5', '3/5', '1/2', '1/5'], answer: 'A', explanation: 'There are 5 balls. Blue balls = 2, so probability = 2/5.' },
    { topic: 'Mensuration', q: 'Find the perimeter of a square of side 9 cm.', options: ['18 cm', '27 cm', '36 cm', '81 cm'], answer: 'C', explanation: 'Perimeter of square = 4 × side = 4 × 9 = 36 cm.' },
    { topic: 'Linear Equations', q: 'Solve: y/3 = 7.', options: ['10', '14', '21', '24'], answer: 'C', explanation: 'Multiply both sides by 3. y = 21.' }
  ],
  pastStyle: [
    { topic: 'Fractions', q: 'A trader sold 2/5 of her oranges in the morning and 1/4 in the afternoon. What fraction was sold altogether?', options: ['3/9', '13/20', '3/20', '7/20'], answer: 'B', explanation: '2/5 = 8/20 and 1/4 = 5/20. Total = 13/20.' },
    { topic: 'Algebra', q: 'Expand: 3(a + 4).', options: ['3a + 4', '3a + 7', '3a + 12', 'a + 12'], answer: 'C', explanation: 'Multiply each term in the bracket by 3: 3a + 12.' },
    { topic: 'Geometry', q: 'The base of a triangle is 10 cm and its height is 8 cm. Find its area.', options: ['18 cm²', '40 cm²', '80 cm²', '160 cm²'], answer: 'B', explanation: 'Area of triangle = 1/2 × base × height = 1/2 × 10 × 8 = 40 cm².' },
    { topic: 'Percentages', q: 'A book costs GHS 80. It is sold at a discount of 10%. What is the discount?', options: ['GHS 4', 'GHS 8', 'GHS 10', 'GHS 72'], answer: 'B', explanation: '10% of 80 = 8.' },
    { topic: 'Statistics', q: 'Find the mode of 2, 5, 7, 5, 8, 5, 9.', options: ['2', '5', '7', '9'], answer: 'B', explanation: 'The mode is the number that occurs most often. 5 occurs three times.' },
    { topic: 'Integers', q: 'Evaluate: −4 + 9 − 3.', options: ['2', '4', '8', '16'], answer: 'A', explanation: '−4 + 9 = 5, and 5 − 3 = 2.' },
    { topic: 'Ratio', q: 'The ratio of boys to girls in a class is 3:5. If there are 24 boys, how many girls are there?', options: ['30', '36', '40', '45'], answer: 'C', explanation: '3 parts = 24, so 1 part = 8. Girls = 5 × 8 = 40.' },
    { topic: 'Word Problem', q: 'A farmer harvested 144 eggs and packed them equally into crates of 12. How many crates were used?', options: ['10', '11', '12', '14'], answer: 'C', explanation: '144 ÷ 12 = 12 crates.' },
    { topic: 'Angles', q: 'An angle is 35° less than a right angle. Find the angle.', options: ['35°', '45°', '55°', '65°'], answer: 'C', explanation: 'A right angle is 90°. 90 − 35 = 55°.' },
    { topic: 'Scale Drawing', q: 'On a map, 1 cm represents 5 km. What distance is represented by 7 cm?', options: ['12 km', '25 km', '35 km', '50 km'], answer: 'C', explanation: '7 × 5 km = 35 km.' },
    { topic: 'Sequences', q: 'Find the next number: 4, 8, 12, 16, __.', options: ['18', '20', '22', '24'], answer: 'B', explanation: 'The sequence increases by 4 each time. 16 + 4 = 20.' },
    { topic: 'Volume', q: 'Find the volume of a cuboid of length 5 cm, width 4 cm and height 3 cm.', options: ['12 cm³', '20 cm³', '60 cm³', '120 cm³'], answer: 'C', explanation: 'Volume = length × width × height = 5 × 4 × 3 = 60 cm³.' }
  ]
}
...
function answerBece(letter) {
  ...
  session.answers.push({ topic: q.topic, correct, question: q.q, answer: letter, correctAnswer: q.answer })
